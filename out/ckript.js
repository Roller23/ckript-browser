...
define("ast", ["require", "exports", "token"], function (require, exports, token_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("utils", ["require", "exports", "ast", "token"], function (require, exports, ast_1, token_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Utils {
        ...
        static opUnary(token) {
            return token === token_2.TokenType.OP_NOT || token === token_2.TokenType.OP_NEG;
        }
    ...
    Utils.opPrecedence = {
        [token_2.TokenType.AND_ASSIGN]: 1,
        [token_2.TokenType.OR_ASSIGN]: 1,
        [token_2.TokenType.XOR_ASSIGN]: 1,
        [token_2.TokenType.OP_ASSIGN]: 1,
        [token_2.TokenType.PLUS_ASSIGN]: 1,
        [token_2.TokenType.MINUS_ASSIGN]: 1,
        [token_2.TokenType.MUL_ASSIGN]: 1,
        [token_2.TokenType.DIV_ASSIGN]: 1,
        [token_2.TokenType.MOD_ASSIGN]: 1,
        [token_2.TokenType.LSHIFT_ASSIGN]: 1,
        [token_2.TokenType.RSHIFT_ASSIGN]: 1,
        [token_2.TokenType.OP_OR]: 2,
        [token_2.TokenType.OP_AND]: 3,
        [token_2.TokenType.OP_OR_BIT]: 4,
        [token_2.TokenType.OP_XOR]: 5,
        [token_2.TokenType.OP_AND_BIT]: 6,
        [token_2.TokenType.OP_NOT_EQ]: 7,
        [token_2.TokenType.OP_EQ]: 7,
        [token_2.TokenType.OP_GT]: 8,
        [token_2.TokenType.OP_LT]: 8,
        [token_2.TokenType.OP_GT_EQ]: 8,
        [token_2.TokenType.OP_LT_EQ]: 8,
        [token_2.TokenType.LSHIFT]: 9,
        [token_2.TokenType.RSHIFT]: 9,
        [token_2.TokenType.OP_PLUS]: 10,
        [token_2.TokenType.OP_MINUS]: 10,
        [token_2.TokenType.OP_MUL]: 11,
        [token_2.TokenType.OP_DIV]: 11,
        [token_2.TokenType.OP_MOD]: 11,
        [token_2.TokenType.DOT]: 13,
        [token_2.TokenType.LEFT_BRACKET]: 13 // []
    };
});
define("vm", ["require", "exports", "utils"], function (require, exports, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("evaluator", ["require", "exports", "ast", "error-handler", "token", "utils", "vm"], function (require, exports, ast_2, error_handler_1, token_3, utils_2, vm_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Operator {
        constructor(opType, arg) {
            ...
            this.funcCall = [];
            this.indexRpn = [];
            this.type = token_3.TokenType.UNKNOWN;
            this.opType = opType;
    ...
    class RpnElement {
        constructor(type, arg) {
            ...
            this.value = new vm_1.Value(utils_2.VarType.UNKNOWN);
            this.type = type;
    ...
    class Evaluator {
        ...
        stringify(val) {
            ...
            else if (val.type === utils_2.VarType.STR) {
                return val.value;
            }
            else if (val.type === utils_2.VarType.BOOL) {
                return val.value ? 'true' : 'false';
            }
            else if (val.type === utils_2.VarType.NUM) {
                return val.value.toString();
            }
            else if (val.type === utils_2.VarType.FUNC) {
                return 'function';
            }
            else if (val.type === utils_2.VarType.CLASS) {
                return 'class';
            }
            else if (val.type === utils_2.VarType.OBJ) {
                return 'object';
            }
            else if (val.type === utils_2.VarType.ARR) {
                return 'array';
            }
            else if (val.type === utils_2.VarType.VOID) {
                return 'void';
            }
            else if (val.type === utils_2.VarType.UNKNOWN) {
                return 'null';
            }
            else if (val.type === utils_2.VarType.ID) {
        ...
        static makeCopy(val) {
            if (Evaluator.primitiveTypes.includes(val.type)) {
                ...
                let newVal = new vm_1.Value(utils_2.VarType.ID);
                newVal.referenceName = val.referenceName;
                return newVal;
            }
            else if (val.type === utils_2.VarType.REF) {
                let newVal = new vm_1.Value(utils_2.VarType.REF);
                newVal.heapRef = val.heapRef;
                return newVal;
            }
            else if (val.type === utils_2.VarType.ARR) {
                let newVal = new vm_1.Value(utils_2.VarType.ARR);
                ...
                let newVal = new vm_1.Value(utils_2.VarType.OBJ);
                ...
                let newVal = new vm_1.Value(utils_2.VarType.FUNC);
                newVal.thisRef = val.thisRef;
                newVal.func = new ast_2.FuncExpression();
        ...
        setMember(members, expression) {
            ...
            for (const member of members) {
                ...
                if (temp.type !== utils_2.VarType.OBJ) {
        ...
        setIndex(stmt) {
            ...
            for (const index of stmt.indexes) {
                let temp = references[references.length - 1];
                temp = temp.heapRef !== -1 ? this.getHeapVal(temp.heapRef) : temp;
                if (temp.type !== utils_2.VarType.ARR) {
                ...
                if (indexVal.type !== utils_2.VarType.NUM || !Number.isInteger(indexVal.type)) {
        ...
        logicalNot(x) {
            ...
            if (xVal.type === utils_2.VarType.BOOL) {
                return Evaluator.RpnVal(new vm_1.Value(utils_2.VarType.BOOL, !xVal.value));
            }
        ...
        bitwiseNot(x) {
            const xVal = this.getValue(x);
            if (xVal.type === utils_2.VarType.NUM) {
                return Evaluator.RpnVal(new vm_1.Value(utils_2.VarType.NUM, ~xVal.value));
            }
        ...
        performAddition(x, y) {
            ...
            if (xVal.type === utils_2.VarType.ARR) {
                if (yVal.type === utils_2.Utils.varLUT[xVal.arrayType]) {
            ...
            else if (yVal.type === utils_2.VarType.ARR) {
                if (xVal.type === utils_2.Utils.varLUT[yVal.arrayType]) {
            ...
            else if (xVal.type === utils_2.VarType.STR || yVal.type === utils_2.VarType.STR) {
                let val = new vm_1.Value(utils_2.VarType.STR);
                val.value = this.stringify(xVal) + this.stringify(yVal);
                return Evaluator.RpnVal(val);
            }
            else if (xVal.type === utils_2.VarType.NUM && yVal.type === utils_2.VarType.NUM) {
                let val = new vm_1.Value(utils_2.VarType.NUM);
                val.value = xVal.value + yVal.value;
                return Evaluator.RpnVal(val);
            }
            this.throwError(`Cannot perform addition on ${this.stringify(xVal)} and ${this.stringify(yVal)}`);
            return Evaluator.RpnVal(new vm_1.Value(utils_2.VarType.UNKNOWN));
        }
        performSubtraction(x, y) {
            const xVal = this.getValue(x);
            const yVal = this.getValue(y);
            if (xVal.type === utils_2.VarType.NUM && yVal.type === utils_2.VarType.NUM) {
                let val = new vm_1.Value(utils_2.VarType.NUM, xVal.value - yVal.value);
                return Evaluator.RpnVal(val);
            }
            else if (xVal.type === utils_2.VarType.ARR && yVal.isInteger()) {
                let xValCpy = Evaluator.makeCopy(xVal);
        ...
        bitwiseXor(x, y) {
            const xVal = this.getValue(x);
            const yVal = this.getValue(y);
            if (xVal.type === utils_2.VarType.ARR && yVal.type === utils_2.VarType.ARR) {
        ...
        logicalAnd(x, y) {
            const xVal = this.getValue(x);
            const yVal = this.getValue(y);
            if (xVal.type === utils_2.VarType.BOOL && yVal.type === utils_2.VarType.BOOL) {
                let val = new vm_1.Value(utils_2.VarType.BOOL, xVal.value && yVal.value);
                return Evaluator.RpnVal(val);
            }
        ...
        assign(x, y) {
            ...
            if (xValue.type === utils_2.VarType.UNKNOWN) {
        ...
        accessMember(x, y) {
            ...
            if (obj.type !== utils_2.VarType.OBJ) {
            ...
            if (val.type === utils_2.VarType.FUNC) {
        ...
        accessIndex(arr, idx) {
            ...
            if (array.type !== utils_2.VarType.ARR) {
        ...
        compareEq(x, y) {
            ...
            const yVal = this.getValue(y);
            if ((xVal.type === utils_2.VarType.NUM && yVal.type === utils_2.VarType.NUM) ||
                (xVal.type === utils_2.VarType.STR && yVal.type === utils_2.VarType.STR) ||
                (xVal.type === utils_2.VarType.BOOL && yVal.type === utils_2.VarType.BOOL)) {
                let val = new vm_1.Value(utils_2.VarType.BOOL, xVal.value === yVal.value);
                return Evaluator.RpnVal(val);
            }
        ...
        compareGtEq(x, y) {
            ...
            const val = new vm_1.Value(utils_2.VarType.BOOL, gt.value.value || eq.value.value);
            return Evaluator.RpnVal(val);
        }
        compareLtEq(x, y) {
        ...
        registerClass(_class) {
            ...
            _var.type = 'class';
            _var.val.type = utils_2.VarType.CLASS;
        ...
        declareVariable(declaration) {
            ...
            const varType = utils_2.Utils.varLUT[decl.varType];
            ...
            if (decl.isAllocated) {
                ...
                if (varVal.type === utils_2.VarType.OBJ) {
        ...
        constructObject(call, _class) {
            let val = new vm_1.Value(utils_2.VarType.OBJ);
            ...
            for (const nodeList of call.op.funcCall) {
                ...
                if (argType !== utils_2.Utils.varLUT[member.typeName]) {
        ...
        executeFunction(fn, call) {
            ...
            if (fnValue.type === utils_2.VarType.CLASS) {
                return this.constructObject(call, fn);
            }
            if (fnValue.type === utils_2.VarType.STR) {
                let args = 0;
                for (const arg of call.op.funcCall) {
                    if (arg.length !== 0) {
                        args++;
            ...
            if (fnValue.type !== utils_2.VarType.FUNC) {
            ...
            if (fnValue.func.params.length !== 0) {
                ...
                for (const nodeList of call.op.funcCall) {
                    ...
                    let argType = argVal.type;
                    const expectedType = utils_2.Utils.varLUT[fnParam.typeName];
            ...
            if (fnValue.func.retRef) {
                ...
                if (heapVal.type !== utils_2.Utils.varLUT[fnValue.func.retType]) {
            ...
            if (funcEvaluator.returnValue.type !== utils_2.Utils.varLUT[fnValue.func.retType]) {
        ...
        executeStatement(statement) {
            ...
            if (stmt.type === ast_2.StmtType.NONE) {
            ...
            else if (stmt.type === ast_2.StmtType.WHILE) {
                if (stmt.statements.length === 0)
                    return Evaluator.FLAG_OK;
                ...
                while (true) {
                    ...
                    if (result.type !== utils_2.VarType.BOOL) {
            ...
            else if (stmt.type === ast_2.StmtType.FOR) {
            ...
            else if (stmt.type === ast_2.StmtType.IF) {
                if (stmt.statements.length === 0)
                    return Evaluator.FLAG_OK;
                if (stmt.expressions[0].length === 0) {
        ...
        nodeToElement(node) {
            const expr = node.obj;
            if (expr.isOperand()) {
                if (expr.type === ast_2.ExprType.FUNC_CALL) {
                    return Evaluator.RpnOp(OperatorType.FUNC, expr.argsList);
                }
                else if (expr.type === ast_2.ExprType.INDEX) {
            ...
            else if (expr.type === ast_2.ExprType.BOOL_EXPR) {
                return Evaluator.RpnVal(new vm_1.Value(utils_2.VarType.BOOL, expr.literal));
            }
            else if (expr.type === ast_2.ExprType.STR_EXPR) {
                return Evaluator.RpnVal(new vm_1.Value(utils_2.VarType.STR, expr.literal));
            }
            else if (expr.type === ast_2.ExprType.NUM_EXPR) {
                return Evaluator.RpnVal(new vm_1.Value(utils_2.VarType.NUM, expr.literal));
            }
            else if (expr.type === ast_2.ExprType.IDENTIFIER_EXPR) {
                let res = Evaluator.RpnVal(new vm_1.Value(utils_2.VarType.ID));
                res.value.referenceName = expr.literal;
                return res;
            }
            else if (expr.type === ast_2.ExprType.FUNC_EXPR) {
                // TODO: Check if this is correct
                let res = Evaluator.RpnVal(new vm_1.Value(utils_2.VarType.FUNC));
                res.value.func = expr.funcExpr;
                return res;
            }
            else if (expr.type === ast_2.ExprType.ARRAY) {
                let val = new vm_1.Value(utils_2.VarType.ARR);
                let initialSize = new vm_1.Value(utils_2.VarType.NUM);
                let elementsCount = 0;
                ...
                if (initialSize.value !== 0) {
                    ...
                    for (let i = 0; i < initialSize.value; i++) {
                        val.arrayValues[i] = new vm_1.Value(utils_2.VarType.UNKNOWN);
                    }
                }
                const arrType = utils_2.Utils.varLUT[expr.arrayType];
        ...
        flattenTree(res, expressionTree) {
            for (const node of expressionTree) {
                const expr = node.obj;
                const isRpn = expr.type === ast_2.ExprType.RPN;
            ...
            for (const token of rpnStack) {
                if (token.type === ElementType.OPERATOR) {
                    if (token.op.opType === OperatorType.BASIC) {
                        if (utils_2.Utils.opBinary(token.op.type)) {
                            if (resStack.length < 2) {
                                this.throwError(`Operator ${token_3.Token.getName(token.op.type)} expects two operands`);
                            }
                            const y = resStack.pop();
                            const x = resStack.pop();
                            if (token.op.type === token_3.TokenType.DOT) {
                                resStack.push(this.accessMember(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_PLUS) {
                                resStack.push(this.performAddition(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_MINUS) {
                                resStack.push(this.performSubtraction(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_MUL) {
                                resStack.push(this.performMultiplication(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_DIV) {
                                resStack.push(this.performDivision(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_MOD) {
                                resStack.push(this.performModulo(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_ASSIGN) {
                                resStack.push(this.assign(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_EQ) {
                                resStack.push(this.compareEq(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_NOT_EQ) {
                                resStack.push(this.compareNeq(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_GT) {
                                resStack.push(this.compareGt(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_LT) {
                                resStack.push(this.compareLt(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_GT_EQ) {
                                resStack.push(this.compareGtEq(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_LT_EQ) {
                                resStack.push(this.compareLtEq(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.PLUS_ASSIGN) {
                                resStack.push(this.plusAssign(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.MINUS_ASSIGN) {
                                resStack.push(this.minusAssign(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.MUL_ASSIGN) {
                                resStack.push(this.mulAssign(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.DIV_ASSIGN) {
                                resStack.push(this.divAssign(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_OR) {
                                resStack.push(this.logicalOr(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_AND) {
                                resStack.push(this.logicalAnd(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.LSHIFT) {
                                resStack.push(this.shiftLeft(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.RSHIFT) {
                                resStack.push(this.shiftRight(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_XOR) {
                                resStack.push(this.bitwiseXor(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_AND_BIT) {
                                resStack.push(this.bitwiseAnd(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OP_OR_BIT) {
                                resStack.push(this.bitwiseOr(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.RSHIFT_ASSIGN) {
                                resStack.push(this.rshiftAssign(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.LSHIFT_ASSIGN) {
                                resStack.push(this.lshiftAssign(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.AND_ASSIGN) {
                                resStack.push(this.andAssign(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.OR_ASSIGN) {
                                resStack.push(this.orAssign(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.XOR_ASSIGN) {
                                resStack.push(this.xorAssign(x, y));
                            }
                            else if (token.op.type === token_3.TokenType.MOD_ASSIGN) {
                                resStack.push(this.modAssign(x, y));
                            }
                            else {
                                this.throwError(`Unknown binary operator ${token_3.Token.getName(token.op.type)}`);
                            }
                        }
                        else if (utils_2.Utils.opUnary(token.op.type)) {
                            if (resStack.length < 1) {
                                this.throwError(`Operator ${token_3.Token.getName(token.op.type)} expects one operand`);
                            }
                            const x = resStack.pop();
                            if (token.op.type === token_3.TokenType.OP_NOT) {
                                resStack.push(this.logicalNot(x));
                            }
                            else if (token.op.type === token_3.TokenType.OP_NEG) {
                                resStack.push(this.bitwiseNot(x));
                            }
                            else {
                                this.throwError(`Uknkown unary operator ${token_3.Token.getName(token.op.type)}`);
                            }
                        }
                    }
    ...
    Evaluator.primitiveTypes = [
        utils_2.VarType.BOOL, utils_2.VarType.NUM, utils_2.VarType.STR
    ];
});
define("lexer", ["require", "exports", "token", "error-handler"], function (require, exports, token_4, error_handler_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Lexer {
        ...
        throwError(cause) {
            error_handler_2.ErrorHandler.throwError(`Token error: ${cause} (line ${this.currentLine})`);
        }
        consumeWhitespace() {
        ...
        addToken(type, value) {
            this.tokens.push(new token_4.Token(type, value, this.currentLine));
        }
        tokenize(code) {
            this.ptr = 0;
                ...
                if (Lexer.chars.includes(c)) {
                    ...
                    if (Lexer.isAlpha(c) || c === '_') {
                        ...
                        if (Lexer.allowedTokenKeys.includes(tokenString)) {
                            const strTokenType = token_4.TokenType[tokenString.toUpperCase()];
                            this.addToken(strTokenType, '');
                        }
                        else {
                            if (!Lexer.builtinTypes.includes(tokenString)) {
                                this.addToken(token_4.TokenType.IDENTIFIER, tokenString);
                            }
                            else {
                                this.addToken(token_4.TokenType.TYPE, tokenString);
                            }
                        }
                    }
                    else if (c === '"' || c === '\'' || c === '`') {
                        ...
                        this.addToken(token_4.TokenType.STRING_LITERAL, str);
                    }
                        ...
                        this.ptr--;
                        let negation = this.tokens.length !== 0 && this.tokens[this.tokens.length - 1].type === token_4.TokenType.OP_MINUS && !this.deletedSpaces;
                        if (negation && !this.prevDeletedSpaces) {
                            if (this.tokens.length !== 0) {
                                const t = this.tokens[this.tokens.length - 1].type;
                                if (t === token_4.TokenType.IDENTIFIER || t === token_4.TokenType.NUMBER || t === token_4.TokenType.LEFT_PAREN) {
                                    negation = false;
                                }
                            }
                        }
                        ...
                        this.addToken(token_4.TokenType.NUMBER, numberStr);
                    }
                        ...
                        if (op.length === 1) {
                            ...
                            if (op === '//') {
                                ...
                                this.addToken(token_4.TokenType.OP_EQ, '');
                            }
                            else if (op === '!=') {
                                this.addToken(token_4.TokenType.OP_NOT_EQ, '');
                            }
                            else if (op === '&&') {
                                this.addToken(token_4.TokenType.OP_AND, '');
                            }
                            else if (op === '||') {
                                this.addToken(token_4.TokenType.OP_OR, '');
                            }
                            else if (op === '>>') {
                                this.addToken(token_4.TokenType.RSHIFT, '');
                            }
                            else if (op === '<<') {
                                this.addToken(token_4.TokenType.LSHIFT, '');
                            }
                            else if (op === '>>=') {
                                this.addToken(token_4.TokenType.RSHIFT_ASSIGN, '');
                            }
                            else if (op === '<<=') {
                                this.addToken(token_4.TokenType.LSHIFT_ASSIGN, '');
                            }
                            else if (op === '+=') {
                                this.addToken(token_4.TokenType.PLUS_ASSIGN, '');
                            }
                            else if (op === '-=') {
                                this.addToken(token_4.TokenType.MINUS_ASSIGN, '');
                            }
                            else if (op === '*=') {
                                this.addToken(token_4.TokenType.MUL_ASSIGN, '');
                            }
                            else if (op === '/=') {
                                this.addToken(token_4.TokenType.DIV_ASSIGN, '');
                            }
                            else if (op === '|=') {
                                this.addToken(token_4.TokenType.OR_ASSIGN, '');
                            }
                            else if (op === '&=') {
                                this.addToken(token_4.TokenType.AND_ASSIGN, '');
                            }
                            else if (op === '^=') {
                                this.addToken(token_4.TokenType.XOR_ASSIGN, '');
                            }
                            else if (op === '%=') {
                                this.addToken(token_4.TokenType.MOD_ASSIGN, '');
                            }
                            else if (op === '>=') {
                                this.addToken(token_4.TokenType.OP_GT_EQ, '');
                            }
                            else if (op === '<=') {
                                this.addToken(token_4.TokenType.OP_LT_EQ, '');
                            }
                            else {
...
define("parser", ["require", "exports", "error-handler", "token", "ast", "utils"], function (require, exports, error_handler_3, token_5, ast_3, utils_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Parser {
        constructor(tokens, terminal) {
            this.tokens = [];
            this.prev = token_5.Token.getDefault();
            this.pos = 0;
            this.tokens = tokens;
            this.terminal = terminal;
            this.tokensCount = this.tokens.length;
            this.currToken = this.tokensCount ? this.tokens[0] : token_5.Token.getDefault();
        }
        throwError(cause, token) {
            error_handler_3.ErrorHandler.throwError(`Syntax error: ${cause} (line ${token.line})`);
        }
        failIfEOF(expected) {
            if (this.currToken.type === token_5.TokenType.NONE) {
                this.throwError(`Reached end of file but ${token_5.Token.getName(expected)} expected`, this.currToken);
            }
        }
        advance() {
            this.pos++;
            ...
            if (this.pos < this.tokensCount) {
                ...
                this.currToken = token_5.Token.getDefault();
                this.pos--;
            }
        }
        lookahead(offset) {
            if (this.pos + offset < 0)
                return token_5.Token.getDefault();
        ...
        findEnclosingBrace(startPos, braces = 0) {
            ...
            while (true) {
                ...
                if (this.tokens[startPos + i].type === token_5.TokenType.LEFT_BRACE) {
                    braces++;
                }
                if (this.tokens[startPos + i].type === token_5.TokenType.RIGHT_BRACE) {
                    braces--;
                    if (braces === 0) {
                        return i;
                    }
        ...
        getManyStatements(node) {
            ...
            while (true) {
                ...
                if (statement.type === ast_3.NodeType.UNKNOWN)
                    break;
                res.push(statement);
            }
            return res;
        ...
        parseClassStmt() {
            let classExpr = new ast_3.Node(new ast_3.Statement(new ast_3.ClassStatement()));
            let stmt = classExpr.toStmt();
            stmt.line = this.currToken.line;
            this.advance(); // skip the class
            if (this.currToken.type !== token_5.TokenType.IDENTIFIER) {
            ...
            if (this.currToken.type !== token_5.TokenType.LEFT_PAREN) {
            ...
            this.advance(); // skip the )
            if (this.currToken.type !== token_5.TokenType.SEMI_COLON) {
                this.throwError(`invalid class declaration, expected ';', but ${this.currToken.getName()} found`, this.currToken);
            }
            this.advance(); // skip the ;
            return classExpr;
        ...
        getStatement(prev, stop) {
            if (this.currToken.type === stop) {
            ...
            else if (this.currToken.type === token_5.TokenType.CLASS) {
                return this.parseClassStmt();
            }
            else if (this.currToken.type === token_5.TokenType.SET) {
                let set = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.SET));
                let stmt = set.toStmt();
                stmt.line = this.currToken.line;
                this.advance(); // skip the $
                if (this.currToken.type != token_5.TokenType.IDENTIFIER) {
                ...
                while (true) {
                    if (this.currToken.type !== token_5.TokenType.DOT) {
                    ...
                    stmt.objMembers.push(this.currToken.value);
                    this.advance(); // skip the id
                    if (this.currToken.type === token_5.TokenType.OP_ASSIGN)
                        break;
                }
                this.advance(); // skip the =
                stmt.expressions.push(this.getExpression(token_5.TokenType.SEMI_COLON));
                this.advance(); // skip the ;
                return set;
            }
            else if (this.currToken.type === token_5.TokenType.SET_IDX) {
                let setIdx = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.SET_IDX));
                ...
                while (true) {
                    ...
                    if (idxExpr.toExpr().type !== ast_3.ExprType.INDEX) {
            ...
            else if (this.currToken.type === token_5.TokenType.LEFT_BRACE) {
                let comp = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.COMPOUND));
                ...
                let blockParser = new Parser(blockStart, token_5.TokenType.RIGHT_BRACE);
            ...
            else if (this.currToken.type === token_5.TokenType.IF) {
                ...
                let ifStmt = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.IF));
                let stmt = ifStmt.toStmt();
                stmt.line = line;
                this.advance(); // skip the (
                stmt.expressions.push(this.getExpression(token_5.TokenType.RIGHT_PAREN));
                this.advance(); // skip the )
                stmt.statements.push(this.getStatement(prev, stop));
                if (this.currToken.type === token_5.TokenType.ELSE) {
                    this.advance(); // skip else
                    stmt.statements.push(this.getStatement(prev, stop));
                }
                return ifStmt;
            }
            else if (this.currToken.type === token_5.TokenType.WHILE) {
                const line = this.currToken.line;
                ...
                let whileStmt = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.WHILE));
            ...
            else if (this.currToken.type === token_5.TokenType.FOR) {
                const line = this.currToken.line;
                this.advance(); // skip the for
                if (this.currToken.type !== token_5.TokenType.LEFT_PAREN) {
                    this.throwError(`invalid for statement. Expected '(' but ${this.currToken.getName()} found`, this.currToken);
                }
                let forStmt = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.FOR));
                let stmt = forStmt.toStmt();
                stmt.line = line;
                this.advance(); // skip the (
                stmt.expressions = this.getManyExpressions(token_5.TokenType.SEMI_COLON, token_5.TokenType.RIGHT_PAREN);
                this.advance(); // skip the )
                stmt.statements.push(this.getStatement(prev, stop));
                return forStmt;
            }
            else if (this.currToken.type === token_5.TokenType.RETURN) {
                let returnStmt = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.RETURN));
            ...
            else if (this.currToken.type === token_5.TokenType.BREAK) {
                const line = this.currToken.line;
                ...
                this.advance(); // skip the ;
                let continueStmt = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.BREAK));
                let stmt = continueStmt.toStmt();
                stmt.line = line;
                return continueStmt;
            }
            else if (this.currToken.type === token_5.TokenType.CONTINUE) {
                const line = this.currToken.line;
                ...
                this.advance(); // skip the ;
                let continueStmt = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.CONTINUE));
                let stmt = continueStmt.toStmt();
                stmt.line = line;
                return continueStmt;
            }
            else if (this.currToken.type === token_5.TokenType.TYPE) {
                if (this.currToken.value === 'void') {
                    this.throwError(`invalid variable declaration. Cannot declare a void variable`, this.currToken);
                }
                const line = this.currToken.line;
                const allocated = this.prev.type === token_5.TokenType.ALLOC;
                let constant = this.prev.type === token_5.TokenType.CONST;
                const reference = this.prev.type === token_5.TokenType.REF;
                if (allocated && this.lookahead(-2).type === token_5.TokenType.CONST) {
                    constant = true;
                }
                let varDecl = new ast_3.Node(new ast_3.Declaration(ast_3.DeclType.VAR_DECL));
                ...
                this.advance(); // skip the =
                decl.varExpression = this.getExpression(token_5.TokenType.SEMI_COLON);
                decl.isAllocated = allocated;
                decl.isConstant = constant;
                decl.isReference = reference;
                let declStmt = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.DECL));
            ...
            else if (this.currToken.type === token_5.TokenType.ALLOC) {
                this.advance(); // skip the alloc
                if (this.currToken.type !== token_5.TokenType.TYPE) {
            ...
            else if (this.currToken.type === token_5.TokenType.REF) {
                this.advance(); // skip the alloc
                if (this.currToken.type !== token_5.TokenType.TYPE) {
            ...
            else if (this.currToken.type === token_5.TokenType.CONST) {
                this.advance(); // skip the const
                if (this.currToken.type !== token_5.TokenType.TYPE && this.currToken.type !== token_5.TokenType.ALLOC && this.currToken.type !== token_5.TokenType.REF) {
            ...
            else if (this.currToken.type === token_5.TokenType.SEMI_COLON && prev.type === ast_3.NodeType.UNKNOWN) {
                let nopStmt = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.NOP));
                ...
                const line = this.currToken.line;
                let expr = this.getExpression(token_5.TokenType.SEMI_COLON);
                let exprStmt = new ast_3.Node(new ast_3.Statement(ast_3.StmtType.EXPR));
        ...
        peek(stack) {
            return stack.length === 0 ? new ast_3.Node(null) : stack[stack.length - 1];
        }
        getExpression(stop1, stop2 = token_5.TokenType.NONE) {
            let queue = [];
            let stack = [];
            while (this.currToken.type !== stop1 && this.currToken.type !== stop2) {
                ...
                if (tok.toExpr().isEvaluable()) {
                    ...
                    while (top.type !== ast_3.NodeType.UNKNOWN && top.toExpr().isOperand()
                        &&
                            (utils_3.Utils.getPrecedence(top.toExpr()) > utils_3.Utils.getPrecedence(tok.toExpr())
                                ||
                                    (utils_3.Utils.getPrecedence(top.toExpr()) === utils_3.Utils.getPrecedence(tok.toExpr())
                                        && !utils_3.Utils.isRightAssoc(tok)))
                        &&
                            (top.toExpr().type !== ast_3.ExprType.LPAREN)) {
                        queue.push(stack.pop());
                        top = this.peek(stack);
                    }
                    stack.push(tok);
                }
                else if (tok.toExpr().type === ast_3.ExprType.LPAREN) {
                    stack.push(tok);
                }
            }
            while (this.peek(stack).type !== ast_3.NodeType.UNKNOWN) {
                queue.push(stack.pop());
            }
            return queue;
        }
        parseFuncParams(isClass = false) {
            let res = [];
            const stop = token_5.TokenType.RIGHT_PAREN;
            let paramNames = new Set();
            while (true) {
                this.failIfEOF(token_5.TokenType.TYPE);
                let isRef = false;
                if (this.currToken.type === token_5.TokenType.REF) {
                    isRef = true;
                ...
                let param = new ast_3.FuncParam(type, this.currToken.value);
                param.isRef = isRef;
                res.push(param);
                this.advance();
                this.failIfEOF(stop);
        ...
        parseFuncExpression() {
            let func = new ast_3.Node(new ast_3.Expression(ast_3.ExprType.FUNC_EXPR));
            let expr = func.toExpr();
            expr.funcExpr = new ast_3.FuncExpression();
            this.advance(); // skip the function
            if (this.currToken.type === token_5.TokenType.OP_GT) {
            ...
            this.advance();
            const returnsRef = this.currToken.type === token_5.TokenType.REF;
            if (returnsRef) {
                this.advance(); // skip the ref
            }
            if (this.currToken.type !== token_5.TokenType.TYPE) {
            ...
            this.advance(); // skip the type
            if (this.currToken.type !== token_5.TokenType.LEFT_BRACE) {
                this.throwError(`invalid function declaration, expected '{', but ${this.currToken.getName()} found`, this.currToken);
            }
            const funcEnd = this.findBlockEnd();
            let funcStart = this.tokens.slice(this.pos, this.pos + funcEnd + 1);
            let funcParser = new Parser(funcStart, token_5.TokenType.NONE);
        ...
        parseArrayExpression() {
            ...
            let array = new ast_3.Node(new ast_3.Expression(ast_3.ExprType.ARRAY));
            if (this.currToken.type !== token_5.TokenType.LEFT_PAREN) {
                this.throwError(`invalid array expression, expected '(', but ${this.currToken.getName()} found`, this.currToken);
            }
            this.advance(); // skip the (
            let expr = array.toExpr();
            expr.argsList = this.getManyExpressions(token_5.TokenType.COMMA, token_5.TokenType.RIGHT_PAREN);
            this.advance(); // skip the )
            const hasSize = this.currToken.type === token_5.TokenType.LEFT_BRACKET;
            if (hasSize) {
                this.advance(); // skip the [
                expr.arraySize = this.getExpression(token_5.TokenType.RIGHT_BRACKET);
                this.advance(); // skip the ]
            }
            if (this.currToken.type === token_5.TokenType.REF) {
        ...
        getExprNode() {
            this.failIfEOF(token_5.TokenType.GENERAL_EXPRESSION);
            if (this.currToken.type === token_5.TokenType.FUNCTION) {
                return this.parseFuncExpression();
            }
            else if (this.currToken.type === token_5.TokenType.ARRAY) {
                return this.parseArrayExpression();
            }
            else if (this.currToken.type === token_5.TokenType.IDENTIFIER) {
                let id = new ast_3.Node(new ast_3.Expression(ast_3.ExprType.IDENTIFIER_EXPR, this.currToken.value));
                this.advance();
                return id;
            }
            else if (this.currToken.type === token_5.TokenType.LEFT_PAREN) {
                if (this.prev.type === token_5.TokenType.RIGHT_PAREN || this.prev.type === token_5.TokenType.IDENTIFIER ||
                    this.prev.type === token_5.TokenType.RIGHT_BRACKET || this.prev.type === token_5.TokenType.STRING_LITERAL) {
                    let fc = [];
                    let call = new ast_3.Node(new ast_3.Expression(ast_3.ExprType.FUNC_CALL, fc));
                    this.advance(); // skip the (
                    ...
                    this.advance(); // skip the (
                    const rpn = this.getExpression(token_5.TokenType.RIGHT_PAREN);
                    this.advance(); // skip the )
                    return new ast_3.Node(new ast_3.Expression(ast_3.ExprType.RPN, rpn));
                }
            }
            else if (this.currToken.type === token_5.TokenType.LEFT_BRACKET) {
                this.advance(); // skip the [
                let rpn = this.getExpression(token_5.TokenType.RIGHT_BRACKET);
                this.advance(); // skip the ]
                let index = new ast_3.Node(new ast_3.Expression(ast_3.ExprType.INDEX, rpn));
                return index;
            }
            else if (this.currToken.type === token_5.TokenType.STRING_LITERAL) {
                let strLiteral = new ast_3.Node(new ast_3.Expression(ast_3.ExprType.STR_EXPR, this.currToken.value));
                this.advance();
                return strLiteral;
            }
            else if (utils_3.Utils.opUnary(this.currToken.type)) {
                const tokenType = this.currToken.type;
                this.advance(); // skip the op
                this.failIfEOF(token_5.TokenType.GENERAL_EXPRESSION);
                return new ast_3.Node(new ast_3.Expression(ast_3.ExprType.UNARY_OP, tokenType));
            }
            else if (utils_3.Utils.opBinary(this.currToken.type)) {
                const tokenType = this.currToken.type;
                this.advance(); // skip the op
                this.failIfEOF(token_5.TokenType.GENERAL_EXPRESSION);
                return new ast_3.Node(new ast_3.Expression(ast_3.ExprType.BINARY_OP, tokenType));
            }
            else if (this.currToken.type === token_5.TokenType.NUMBER) {
                const isNegative = this.currToken.value[0] === '-';
                let arg = Number(this.currToken.value.substr(isNegative ? 1 : 0));
                if (isNegative) {
                    arg = -arg;
                }
                const numLiteral = new ast_3.Node(new ast_3.Expression(ast_3.ExprType.NUM_EXPR, arg));
                this.advance(); // skip the number
                return numLiteral;
            }
            else if (this.currToken.type === token_5.TokenType.TRUE || this.currToken.type === token_5.TokenType.FALSE) {
                const boolean = new ast_3.Node(new ast_3.Expression(ast_3.ExprType.BOOL_EXPR, this.currToken.type === token_5.TokenType.TRUE));
            ...
            return new ast_3.Node(null);
        }
        parse() {
            let block = new ast_3.Node(null);
...
define("interpreter", ["require", "exports", "evaluator", "lexer", "parser", "token", "utils", "vm"], function (require, exports, evaluator_1, lexer_1, parser_1, token_6, utils_4, vm_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Interpreter {
        processCode(code, args = []) {
            ...
            const [AST] = new parser_1.Parser(tokens, token_6.TokenType.NONE).parse();
            const evaluator = new evaluator_1.Evaluator(AST, new vm_2.CVM());
            const val = (evaluator.stack.argv = new vm_2.Variable()).val;
            val.arrayType = 'str';
            val.type = utils_4.VarType.ARR;
            for (let i = 0; i < args.length; i++) {
                val.arrayValues.push(new vm_2.Value(utils_4.VarType.STR, args[i]));
            }
...
//# sourceMappingURL=ckript.js.map